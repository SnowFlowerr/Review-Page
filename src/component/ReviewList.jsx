...
export default function ReviewList() {
    ...
    function star(i){
        i=Math.floor(i/2);
        if(i===1){
            return <span> <span className='yellow'><i class="fa-solid fa-star"></i> </span><i class="fa-regular fa-star"></i> <i class="fa-regular fa-star"></i> <i class="fa-regular fa-star"></i> <i class="fa-regular fa-star"></i></span>
        }
        else if(i===2){
            return <span><span className='yellow'> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i></span> <i class="fa-regular fa-star"></i> <i class="fa-regular fa-star"></i> <i class="fa-regular fa-star"></i></span>
        }
        if(i===3){
    ...
    function highlight(text,sentiment){
        const Positive= "#D9F2DD";
        const Negative= "#F2DBD9"
        const Mixed= "#e8bd6d3d"
        const Neutral= "#eaf09b6b"
        ...
        if(sentiment==="Positive"){
            ...
            sentiment="transparent"
        }
        let str=text;
        return <mark style={{background: `${sentiment}`}}>{str}</mark>
    }
    return (
        <div className='box'>
            {review.map((review) => <div>
                <div className='singleReview'>
                    <div className='icon'><img src={review.source.icon} alt="" height='35px' /></div>
                    <div className='firstpart'>
                        <div>
                            <div><span className='reviewerName'>{review.reviewer_name}</span> <span className='write'>wrote a review at</span> <span className='reviewersource'>{review.source.name}</span></div>
                        </div>
                        <div><i class="fa-solid fa-user-plus"></i> <i class="fa-solid fa-bookmark"></i> <i class="fa-solid fa-ellipsis"></i></div>
                    </div>
                </div>
                <div className='rating'>
                    <div className='secondpart'>
                        {/* <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i>  */}
                        {star(review.rating_review_score)}
                        <span className='date'>{review.date}</span>
                    </div>{review.analytics.sentiment}
                    <div className='thirdpart'>
                        <div className="content">{highlight(review.content,review.sentiment)}
                        <span className="topic">{review.topic}</span></div>
                    </div>
                </div>
            </div>)}
        </div>
